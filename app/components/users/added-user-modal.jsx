...
const AddedUserModal = ({ editOpen, setEditOpen, user, onUserUpdated }) => {
  ...
  return (
    <Modal isOpen={editOpen} onClose={() => setEditOpen(false)} title="">
      <div className="flex justify-center items-center flex-col bg-white px-5 py-10 w-full">
        <h1 className="text-black mb-[35px] text-center font-semibold text-2xl">
          Edit User
        </h1>

        <form
          className="grid grid-cols-1 md:grid-cols-2 gap-x-[30px] gap-y-[25px]"
        ...
        >
          ...
          <div className="flex flex-col">
            <label className="font-semibold mb-1.5 text-black">
              Phone Number
            </label>
            <input
              className="rounded-xl px-2.5 py-3 border border-[#ccc] text-[15px] placeholder:text-[#aaa]"
          ...
          <div className="col-span-full text-center mt-[30px]">
            <button
              className="bg-black text-white px-6 py-2 rounded font-semibold hover:bg-white hover:text-black transition"
              type="submit"
            >
              Update
            </button>
