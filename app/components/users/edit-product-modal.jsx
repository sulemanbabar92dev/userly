...
const EditProductModal = ({editProduct,setEditProduct,user,onProductUpdated}) => {
    ...
    if (onProductUpdated) onProductUpdated(updatedUser)
  ...
  <div className='flex justify-center items-center flex-col bg-white px-5 py-10 w-full'>
    <h1 className='text-black mb-[35px] text-center font-semibold text-2xl'>Edit Product</h1>
    ...
    onSubmit={handleSubmit}>
      ...
      <div className='col-span-full text-center mt-[30px]'>
        <button className='bg-black text-white px-6 py-2 rounded font-semibold hover:bg-white hover:text-black'type='submit'>
          Update</button>
      </div>
    </form>
  </div>
